<x-app-layout>
    <x-slot name="header">
        <h1 class="text-xl font-semibold text-stone-950">{{ __('My orders') }}</h1>
    </x-slot>

    <div class="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8" data-realtime-scope="orders">
        <div class="rounded-lg border border-stone-200 bg-white">
            ...
            @empty
                <div class="p-6 text-sm text-stone-600">{{ __('No orders yet.') }}</div>
            @endforelse
        </div>
